      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[1600px]">
        <aside className="hidden w-72 shrink-0 border-r border-white/10 bg-slate-950/70 px-5 py-6 backdrop-blur-xl md:flex md:flex-col">
          <div className="flex items-center gap-3 px-2">
            <div className="grid h-11 w-11 place-items-center rounded-2xl bg-yellow-500 text-slate-950 shadow-[0_12px_30px_rgba(250,204,21,0.25)]"><Sun className="h-5 w-5" /></div>
            <div><p className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-400">Solara</p><h1 className="text-xl font-black tracking-tight">Admin</h1></div>
          </div>
