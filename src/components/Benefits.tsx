...
export default function Benefits() {
  return (
    <section className="relative py-24 overflow-hidden bg-slate-950" id="beneficios">
      ...
      {/* IMAGEM DE FUNDO COM OVERLAY - Otimizada */}
      <div className="absolute inset-0 z-0">
        <Image 
          ...
          quality={80}
          sizes="(max-width: 768px) 100vw, 50vw" // Ajuda o navegador a escolher o tamanho certo
        />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {benefits.map((benefit, index) => (
            /* 5. Trocado para m.div com todas as propriedades de animação */
            <m.div 
              key={index}
