'use client';
// Trocado para m para performance superior
          ...
          >
            <div className="bg-slate-900 border border-white/10 rounded-[2.5rem] p-8 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] overflow-hidden">
              ...
              <form className="space-y-5 relative z-10" onSubmit={(e) => e.preventDefault()}>
                ...
                {/* Botão Entrar */}
                <button className="group relative w-full bg-yellow-500 hover:bg-yellow-400 text-black font-black py-4 rounded-2xl transition-all flex items-center justify-center gap-3 overflow-hidden active:scale-[0.98] mt-6 shadow-xl shadow-yellow-500/10">
